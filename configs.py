...
class Config:
    def __init__(self):
        ...
        # Sizes
        self.parser.add_argument('--input_crop_size', type=int, default=32, help='Generators crop size')
        ...
        # Iterations
        self.parser.add_argument('--max_iters', type=int, default=1500, help='# of iterations')

        # Optimization hyper-parameters
        self.parser.add_argument('--g_lr', type=float, default=0.0001, help='initial learning rate for generator') # 2e-4
        self.parser.add_argument('--u_lr', type=float, default=0.0001, help='initial learning rate for upsampler') # 2e-4
